      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className={"w-full md:block md:w-auto " + (switchMenu ? 'block' : 'hidden')} >
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white">
            <li>
              <a href="#" className="md:hover:text-blueEcommerce text-xl block py-2 px-3 bg-transparent md:p-0" >Inicio</a>
            </li>
            <li>
              <a href="#" className="text-xl block py-2 px-3 text-gray-900 md:border-0 md:hover:text-blueEcommerce md:p-0">Favoritos</a>
            </li>
            <li>
              <a href="#" className="text-xl block py-2 px-3 text-gray-900 md:border-0 md:hover:text-blueEcommerce md:p-0">Tendencias</a>
            </li>
            <li>
              <a href="#" className="text-xl block py-2 px-3 text-gray-900 md:border-0 md:hover:text-blueEcommerce md:p-0">Lo mas nuevo</a>
            </li>
          </ul>
        </div>
